...
function CameraPosSync___Init takes nothing returns nothing
    ...
    call TimerStart(CreateTimer(), 0.03, true, function CameraPosSync___TimerFunctionSync)
endfunction
...
function Gunship___RegisterZoomEventsEnum takes nothing returns nothing
    ...
    call TriggerRegisterPlayerEvent(Gunship___nightVisionTrigger, GetEnumPlayer(), EVENT_PLAYER_ARROW_RIGHT_DOWN)
endfunction
...
function CreateUnitsForPlayer2 takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'H003', - 1436.0, 256.5, 270.000, 'H003')
...
function CreateUnitsForPlayer3 takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'H003', 41.9, 232.1, 270.000, 'H003')
...
function Trig_Start_Actions takes nothing returns nothing
    ...
    call CreateMultiboardBJ(2, 3, "TRIGSTR_052")
    set udg_Multiboard=GetLastCreatedMultiboard()
    call MultiboardSetItemWidthBJ(GetLastCreatedMultiboard(), 0, 0, 20.00)
    ...
    call ConditionalTriggerExecute(gg_trg_Route_1)
endfunction
...
// Trigger: Route 1
//===========================================================================
function Trig_Route_1_Func002A takes nothing returns nothing
    call SetCameraTargetControllerNoZForPlayer(GetEnumPlayer(), gg_unit_n000_0003, 0, 0, false)
    call RotateCameraAroundLocBJ(360.00, GetUnitLoc(gg_unit_n000_0003), GetEnumPlayer(), 45.00)
endfunction

function Trig_Route_1_Actions takes nothing returns nothing
    call ForForce(udg_AirForce, function Trig_Route_1_Func002A)
endfunction

//===========================================================================
function InitTrig_Route_1 takes nothing returns nothing
    set gg_trg_Route_1=CreateTrigger()
    call TriggerRegisterTimerEventPeriodic(gg_trg_Route_1, 45.00)
    call TriggerAddAction(gg_trg_Route_1, function Trig_Route_1_Actions)
endfunction
...
function InitTrig_Update_Gunships takes nothing returns nothing
    ...
    call TriggerRegisterTimerEventPeriodic(gg_trg_Update_Gunships, 0.03)
...
function Trig_Victory_Air_Force_Conditions takes nothing returns boolean
    if ( not ( IsPlayerInForce(GetOwningPlayer(GetTriggerUnit()), udg_GroundForce) == true ) ) then
        return false
    endif
...
call ExecuteFunc("jasshelper__initstructs411883234")
...
function jasshelper__initstructs411883234 takes nothing returns nothing
